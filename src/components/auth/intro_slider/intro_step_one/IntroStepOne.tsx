...
import {back, first_active, introImg2, next} from '../../../store/ImageStore';
import {
  decreaseIntroStep,
  increaseIntroStep,
      ...
      <SafeAreaView style={GLOBALSTYLE.just_flex}>
        <View style={GlobalStyle.container_no_space}>
          <View style={GlobalStyle.upperSection}>
            <Image source={introImg2} style={GlobalStyle.introImg} />
          </View>

          <View style={GlobalStyle.bottomSection}>
            <Text style={[GlobalStyle.authTitle]}>
              Matches, Stress-Free Hiring!
            </Text>
            <Text
              style={[
              ...
              We believe that finding the right match should be straightforward,
              and stress-free for both dental staff and practices.
            </Text>
            ...
            <View style={GlobalStyle.paginationContainer}>
              ...
              <Image source={first_active} style={GlobalStyle.paginationDots} />
