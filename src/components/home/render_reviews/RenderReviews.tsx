...
import styles from './StyleRenderReviews';
...
const RenderReviews = ({item}: {item: Review}) => {
  ...
  console.log('item.item.Clinic_profile:', item.Clinic_profile);
        ...
        <View style={GLOBALSTYLE.only_row}>
          ...
          <View style={GLOBALSTYLE.gap_xs}>
            <Text style={GLOBALSTYLE.button_black}>
              {truncateText(item.recruiter_name, 18)}
            </Text>
